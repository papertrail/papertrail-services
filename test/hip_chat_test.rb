...
class HipChatTest < PapertrailServices::TestCase
  ...
  def test_logs
    ...
    #NOTE: utf-8 dash
    expected = %{"cron" search found 5 matches in the past 1 minute — <a href=\"https://papertrailapp.com/searches/392\">https://papertrailapp.com/searches/392</a>}
  ...
  def test_no_entries
    ...
    assert_equal 1, rooms.size
    msgs = rooms['r']
    expected = %{"cron" search found 0 matches in the past 1 minute — <a href=\"https://papertrailapp.com/searches/392\">https://papertrailapp.com/searches/392</a>}
  ...
  def test_escaping
    ...
    #NOTE: utf-8 dash
    expected = %{"cron" search found 1 match in the past 1 minute — <a href=\"https://papertrailapp.com/searches/392\">https://papertrailapp.com/searches/392</a>}
    assert_equal expected, msgs.first
